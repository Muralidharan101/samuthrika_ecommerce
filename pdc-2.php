        ...
        <div class="page-wrapper">
            ...
            <div id="page-content"> 
                ...
                <div class="page-header text-center">
                 ...
                 <!--Breadcrumbs-->
                 <div class="breadcrumbs"><span class="main-title fw-bold">Traditional Courses</span></div>
                 <!--End Breadcrumbs-->
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-img mb-4 mb-md-0">
                                ...
                                <div class="product-details-img product-horizontal-style">
                                    ...
                                    <div class="zoompro-wrap">
                                        ...
                                        <!-- Product Image -->
                                        <div class="zoompro-span"><img id="zoompro" class="w-100" src="<?php echo $path;?>assets/images/speed-write.jpg " data-zoom-image="<?php echo $path;?>assets/images/Class-1.jpg" alt="product" width="600" height="800" /></div>
                                        <!-- End Product Image -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                                ...
                                <div class="product-single-meta">
                                    <h2 class="product-main-title" style="text-transform: capitalize;">Speed Writing Class</h2>
                                        <!-- Product Info -->
                                        <div class="product-info">
                                        <p class="product-cat"><i class="bi bi-book"></i> Languages: <span><a href="#">Tamil</a> <a href="#">/</a> <a href="#">English</a> <a href="#">/</a> <a href="#">Hindi</a> </span></p>
                                        ...
                                        <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span><a href="#">1 hour</a> </span></p>
                                        <p class="product-cat"><i class="icon anm anm-calendar"></i> Days: <span><a href="#">15 days</a></span></p>
                                        <p class="product-cat"><i class="icon anm anm-question-cil me-2"></i><a href="#">Money Back Guarentee</a></p>
                                    </div>
                                    <!-- End Product Info -->
                                    
                                    <!-- Product Price -->
                                    <div class="product-price d-flex-center my-2">
                                        <span class="price old-price">₹1,500</span><span class="price">₹1000</span>
                                    </div>
                                    <!-- End Product Price -->

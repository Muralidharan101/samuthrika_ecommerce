...
<head>
        ...
        <!-- Title Of Site -->
        <title> Samuthrika | Class 8</title>
         <!--BootStrap icons-->
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-img mb-4 mb-md-0">
                                ...
                                <div class="product-details-img product-horizontal-style">
                                    ...
                                    <div class="zoompro-wrap">
                                        ...
                                        <!-- Product Image -->
                                        <div class="zoompro-span"><img id="zoompro" class="w-100" src="<?php echo $path;?>assets/images/classes.jpg" data-zoom-image="<?php echo $path;?>assets/images/Class-1.jpg" alt="product" width="600" height="800" /></div>
                                        <!-- End Product Image -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                                ...
                                <div class="product-single-meta">
                                    <h2 class="product-main-title" style="text-transform: capitalize;">School tuition class - 8</h2>
                                        <!-- Product Info -->
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span class="price old-price">₹5,000</span><span class="price">₹4,500</span>
                                    </div>
                                    <!-- End Product Price -->

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Jewels List</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                    ...
                    success:function(response)
                    {
                        ...
                        if(result.status == 'Success')
                        {
                            ...
                            data.map(function(value) {
                                ...
                                var editButton = `<a href="lead_edit.php?id=${value.id}" class='btn btn-success me-2'><i class="ri ri-pencil-fill"></i></a>`;

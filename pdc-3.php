                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-img mb-4 mb-md-0">
                                ...
                                <div class="product-details-img product-horizontal-style">
                                    ...
                                    <div class="zoompro-wrap">
                                        ...
                                        <!-- Product Image -->
                                        <div class="zoompro-span"><img id="zoompro" class="w-100" src="<?php echo $path;?>assets/images/abacus.jpg" data-zoom-image="<?php echo $path;?>assets/images/Class-1.jpg" alt="product" width="600" height="800" /></div>
                                        <!-- End Product Image -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                                ...
                                <div class="product-single-meta">
                                    <h2 class="product-main-title" style="text-transform: capitalize;">Abacus class</h2>
                                        <!-- Product Info -->
                                        <div class="product-info">
                                        <p class="product-cat"><i class="bi bi-book"></i> Levels : <span><a href="#">0 level</a> <a href="#">/</a> <a href="#">10 level</a></span></p>

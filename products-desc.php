            ...
            <div id="page-content"> 
                ...
                <div class="container">     
                    ...
                    <div class="product-single">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-img mb-4 mb-md-0" id="product-description">
                                <!-- Product Horizontal -->
                            
                             
                             <div class="product-details-img product-horizontal-style" >
                                 <!-- Product Main -->
                                 <div class="zoompro-wrap" id="product-image">
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                             ...
                             <div class="product-single-meta">
                                 <h2 class="product-main-title" style="text-transform: capitalize;">${value.product_name}</h2>
                                     <!-- Product Info -->
